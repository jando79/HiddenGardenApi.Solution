    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      builder.Entity<Backyard>()
        .HasData(
          ...
          new Backyard { BackyardId = 3, Service = "Bread and Pastries", Description = "Day after baked goods", Address = "Pierre’s Bakery, Portland, OR", Instructions = "Come up to the window and ask for Pierre!"}
        );
    }
  }
}